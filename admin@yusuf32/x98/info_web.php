        ...
        <div class='col-lg-10'>                           
          <div class='block'>
            ...
            <div class='block-body'>
              <form class='form' method='POST' action='x98/edit_info.php' enctype='multipart/form-data'>
                ...
                <div class='form-group'>
                  <label>Logo</label><br>
                  <input name='logo' type='file' class='mr-sm-4'>
                </div>
                <div class='form-group'>
                  <label>Image front</label><br>
                  <input name='foto' type='file' class='mr-sm-4'>
                </div>
                <br>
                <div class='form-group'>
